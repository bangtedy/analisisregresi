...
Pada diagonal, kita melihat distribusi data $y$ dan $x$: data kedua variabel menceng ke kiri (*skewed left*). Di atas diagonal ditunjukkan nilai korelasi $y$ dan $x$ yaitu sebesar=0.625. Dibawah diagonal menunjukkan diagram pencar pasangan data $y$ dengan $x$ yang sudah kita bahas sebelumnya di Bab 1.
...
# library("broom") library perlu dipanggil jika belum dipanggil sebelumnya
...
# library(ggplot2) tidak perlu dipanggil lagi jika sudah dipanggil sebelumnya
# library(ggpmisc) tidak perlu dipanggil lagi jika sudah dipanggil sebelumnya
rumus <- y ~ x
