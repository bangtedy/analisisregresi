...
mpm <- lm(y ~ x) 
# Perintah ini sama dengan y = β0 + β1x
...
```{r plot-residu-mpm, echo=TRUE, warning=FALSE, fig.cap={"Ilustrasi Geometrik dari OLS. Jarak antara Pengamatan dan Garis Regresi Sepanjang Sumbu y"}, fig.align="center"}
