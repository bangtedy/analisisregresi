...
subtitle: "`r if (knitr::is_latex_output()) {'Dengan Menggunakan R'} else {'Dengan Menggunakan R'}`"
...
if (knitr::is_html_output()) {
  meta() |> 
    meta_google_scholar(
      title = "Analisis Regresi Dengan Menggunakan R",
      author = "Tedy Herlambang",
...
<!-- HTML Meta Tags -->
<title>Analisis Regresi Dengan Menggunakan R | Analisis Regresi</title>
<meta name="description" content="Analisis Regresi Dengan Menggunakan R | Analisis Regresi Dengan menggunakan R.">

<!-- Facebook Meta Tags -->
<meta property="og:url" content="https://bangtedy.github.io/analisisregresi/">
<meta property="og:type" content="website">
<meta property="og:title" content="Analisis Regresi Dengan Menggunakan R | Analisis Regresi">
<meta property="og:description" content="Analisis Regresi Dengan Menggunakan R | Analisis Regresi Dengan menggunakan R.">
...
<meta name="twitter:title" content="Analisis Regresi Dengan Menggunakan R | Analisis Regresi">
<meta name="twitter:description" content="Analisis Regresi Dengan Menggunakan R | Analisis Regresi Dengan menggunakan R.">
<meta name="twitter:image" content="https://bangtedy.github.io/analisisregresi//images/analisisregresi-cover.png">

<!-- Meta Tags Generated via https://www.opengraph.xyz -->
      
# Analisis Regresi Dengan Menggunakan R {.unnumbered}
