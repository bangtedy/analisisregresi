...
subtitle: "`r if (knitr::is_latex_output()) {'Sebuah Referensi Singkat dengan Menggunakan R'} else {'Sebuah Referensi Singkat dengan Menggunakan R'}`"
...
description: "Analisis Regresi: Sebuah buku referensi singkat dengan menggunakan R."
...
if (knitr::is_html_output()) {
  meta() |> 
    meta_google_scholar(
      title = "Analisis Regresi: Sebuah Referensi Singkat dengan Menggunakan R",
      author = "Tedy Herlambang",
...
<!-- HTML Meta Tags -->
<title>Analisis Regresi: Sebuah Referensi Singkat dengan Menggunakan R | Analisis Regresi</title>
<meta name="description" content="Analisis Regresi: Sebuah Referensi Singkat dengan Menggunakan R | Analisis Regresi: Sebuah buku referensi singkat dengan menggunakan R.">

<!-- Facebook Meta Tags -->
<meta property="og:url" content="https://bangtedy.github.io/analisisregresi/">
<meta property="og:type" content="website">
<meta property="og:title" content="Analisis Regresi: Sebuah Referensi Singkat dengan Menggunakan R | Analisis Regresi">
<meta property="og:description" content="Analisis Regresi: Sebuah Referensi Singkat dengan Menggunakan R | Analisis Regresi: Sebuah buku referensi singkat dengan menggunakan R.">
...
<meta name="twitter:title" content="Analisis Regresi: Sebuah Referensi Singkat dengan Menggunakan R | Analisis Regresi">
<meta name="twitter:description" content="Analisis Regresi: Sebuah Referensi Singkat dengan Menggunakan R | Analisis Regresi: Sebuah buku referensi singkat dengan menggunakan R.">
<meta name="twitter:image" content="https://bangtedy.github.io/analisisregresi//images/analisisregresi-cover.png">

<!-- Meta Tags Generated via https://www.opengraph.xyz -->
      
# Analisis Regresi: Sebuah Referensi Singkat dengan Menggunakan R {.unnumbered}
...
Buku ini diharapkan menjadi sebuah referensi singkat untuk memperkuat pemahaman pembaca tentang model regresi sebagai salah satu alat analisis yang bisa diterapkan pada berbagai bidang akademik maupun praktik dengan menggunakan R. Tetapi buku ini bukan buku tentang R. Juga bukan buku tentang statistik. 
