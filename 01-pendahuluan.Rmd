...
```{r diagram-pencar, echo=FALSE, warning=FALSE, fig.cap={"Diagram Pencar"}}
...
```{r garis-regresi, echo=FALSE, warning=FALSE, fig.cap={"Diagram Pencar dan Estimasi Garis Linier"}}
PJMotor <- read.delim("PJMotor.txt")
plot(x, y)
